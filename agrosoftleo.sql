...
--
-- Servidor: localhost
-- Tiempo de generación: 12-03-2025 a las 02:54:56
...
CREATE TABLE `bodega` (
  ...
  `ubicacion` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish2_ci DEFAULT NULL,
  `tipo_bodega` enum('Semillero','Cosecha','Herramientas') CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish2_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish2_ci;
